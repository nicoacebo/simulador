...
function App() {
  ...
  const handleSimular = () => {
    ...
    let combinacionesSinResultado = 0;
    const filtradas = [];
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      {mostrarMensaje && (
        <p style={{ marginTop: "1rem", color: "#b33" }}>
          Es posible que alguna de las combinaciones seleccionadas no arroje resultados. En tal caso, puede utilizar OTRA ALTERNATIVA para calcular manualmente.
        </p>
      )}
        </div>
      ) : null}
